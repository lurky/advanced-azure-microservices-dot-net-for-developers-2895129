...
{
    public class PetTransferedToHospitalIntegrationEventHandler : BackgroundService
    {
        private readonly IServiceScopeFactory serviceScopeFactory;
        private readonly ILogger<PetTransferedToHospitalIntegrationEventHandler> logger;
        private readonly ServiceBusClient client;
        private readonly ServiceBusProcessor processor;

        public PetTransferedToHospitalIntegrationEventHandler(IConfiguration configuration,
                                                            IServiceScopeFactory serviceScopeFactory,
                                                            ILogger<PetTransferedToHospitalIntegrationEventHandler> logger)
        {
        ...
        private async Task Processor_ProcessMessageAsync(ProcessMessageEventArgs args)
        {
            ...
            var theEvent = JsonConvert.DeserializeObject<PetTransferedToHospitalIntegrationEvent>(body);
